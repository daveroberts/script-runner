...
module DBMigrations
  ...
  class Scripts
    def self.up
      ...
      db.query(sql)
      sql = "CREATE TABLE `data_containers` (
        `auto_id` INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,
        `id` VARCHAR(255) NOT NULL,
        ...
        INDEX `id_index` (`id`),
        UNIQUE KEY `id` (`id`),
        INDEX `collection_id_index` (`collection`,`collection_id`),
        UNIQUE KEY `collection_id` (`collection`,`collection_id`),
        INDEX `collection_name_index` (`collection`,`name`),
        INDEX `name_index` (`name`),
        INDEX `image_id_index` (`image_id`),
        INDEX `created_at_index` (`created_at`)
      )"
      db.query(sql)
      sql = "CREATE TABLE `data_values` (
        `auto_id` INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,
        `id` VARCHAR(255) NOT NULL,
        `data_container_id` VARCHAR(255) NOT NULL,
        `key` VARCHAR(255) NOT NULL,
        ...
        `linked_collection` VARCHAR(255),
        `linked_collection_id` VARCHAR(255),
        ...
        INDEX `id_index` (`id`),
        UNIQUE KEY `id` (`id`),
        INDEX `data_container_id_index` (`data_container_id`),
        INDEX `dc_key_index` (`data_container_id`,`key`),
        UNIQUE `dc_key` (`data_container_id`,`key`),
        INDEX `summary_index` (`summary`),
        INDEX `linked_image_id_index` (`linked_image_id`),
        INDEX `linked_collection_index` (`linked_collection`,`linked_collection_id`),
