...
class DBSeed
  @scripts = [
    ...
    { id: '17c79465-9dc5-45bb-9894-c4553ca06b15', name: '05 - Numbers - Process', category: 'queue_example', default_input: '44', default_input_mime_type: "JSON", code: "number = int(input())\nnumber = number + 100\nnumber" },
    ...
    { id: 'd6f2a465-6702-444a-bc9d-8157cbd45e20', name: '03 - Other Language Features', category: 'language_examples', default_input: '["Monday","Tuesday","Wednesday"]', default_input_mime_type: "JSON", code: "days = input()\npush(days, 'Thursday')\nforeach day in days {\n  queue('days', day, 'text/plain')\n}\n\n// Count up then down\ncounter = 0\nloop {\n  counter = counter + 1\n  if counter >= 10 { break }\n}\nhigh_value = counter\nwhile counter != 0 {\n  counter = counter - 1\n}\njoin(['Was: ', high_value, ' Counter ended at: ',counter])" },
